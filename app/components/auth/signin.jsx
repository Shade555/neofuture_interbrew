...
export default function SigninComponent() {
  ...
  const inputStyle =
    "appearance-none rounded-lg block w-full px-3 py-2 border border-gray-700 " +
    "placeholder-gray-400 text-white bg-[#3f9371]/10 backdrop-blur-sm " +
    "focus:outline-none focus:ring-[#3f9371] focus:border-[#3f9371] sm:text-sm " +
    "[&:-webkit-autofill]:[-webkit-text-fill-color:white] " +
    "[&:-webkit-autofill]:[-webkit-box-shadow:0_0_0px_1000px_rgba(63,147,113,0.1)_inset]";
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full border border-white rounded-2xl p-5 backdrop-blur-xl bg-black/10">
          <div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  id="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-[#3f9371] focus:ring-[#3f9371] border-gray-700 rounded bg-gray-800"
                />
              ...
              <div className="text-sm">
                <a className="font-medium text-emerald-400 hover:text-emerald-300 transition-colors duration-200">
                  Forgot password?
                </a>
              </div>
            </div>
